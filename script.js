    ...
    meals.then(data=>{
        if (data.meals) {
            data.meals.forEach((element) => {
                ...
                if (isFav) {
                     // Display the meal card as a favorite
                    html += `
                ...
                `;
                    ...
                    // Display the meal card as not a favorite
                    html += `
                <div id="card" class="card mb-3" style="width: 20rem;">
                    <img src="${element.strMealThumb}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            // Display a 404 message if no meals are found
            html += `
        ...
        // Update the main section with the generated HTML
...
async function showFavMealList() {
    ...
    if (arr.length==0) {
        ...
        // Fetch and display each favorite meal
        for (let index = 0; index < arr.length; index++) {
